module resources
   ...
   use iso_c_binding
   implicit none
   integer(c_long), bind(c, name="_thing_size") :: thing_size
   integer(kind=c_unsigned_char), bind(c, name="_thing") :: thing

   integer(c_long), bind(c, name="_ship_png_size") :: ship_png_size
   integer(kind=c_unsigned_char), bind(c, name="_ship_png") :: ship_png

   integer(c_long), bind(c, name="_blackhole_png_size") :: blackhole_png_size
   integer(kind=c_unsigned_char), bind(c, name="_blackhole_png") :: blackhole_png

!   integer(c_int), bind(c, name="ds_ttf_size") :: ds_ttf_size
!   integer(kind=c_unsigned_char), bind(c, name="ds_ttf") :: ds_ttf

   integer(c_long), bind(c, name="_optical_aberration_fs_size") :: optical_aberration_fs_size
   character(kind=c_char), bind(c, name="_optical_aberration_fs") :: optical_aberration_fs
